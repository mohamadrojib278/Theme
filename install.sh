...
while true; do
  ...
  echo -e "${BLUE}'ggg      ,gg'''  .    ggg       Auto Installer Private   ${NC}"
  echo -e "${BLUE}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${BLUE}ggg:     gg.     -   ,ggg       • Telegram : t.me/jibszz     ${NC}"
  echo -e "${BLUE} ggg:     ggg._    _,ggg        • Creadit  : Jibszz ${NC}"
